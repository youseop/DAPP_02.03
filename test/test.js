...
contract('Decentragram', ([deployer, author, tipper]) => {
  ...
  describe('images', async () => {
    ...
    before(async () => {
      //from 에 author를 넣으면 이 값이 msg.sender에서 사용되게 된다.
    ...
    it('creates images', async () => {
      ...
      await decentragram.uploadImage('Image hash', '').should.be.rejected;
    })
    ...
    it('allows users to tip images', async () => {
      ...
      assert.equal(newAuthorBalance.toString(), expectedBalance.toString(),'balance is accurate')
